...
export const RIT_DEPARTMENT_FILES_LOAD_ERROR =
  "[RIT] Department Files Load Error";
...
export const FINANCIAL_INSTITUTE_LOAD_ERROR =
  "[Institute] Financial Institute Load Error";
export const BRANCH_LOAD = "[Institute] Branch Load";
export const BRANCH_LOAD_ERROR = "[Institute] Branch Load Error";
export const FINANCIAL_INSTITUTE_USER_COUNT_LOAD =
  "[Institute] Financial Institute User Count Load";
export const FINANCIAL_INSTITUTE_USER_COUNT_LOAD_ERROR =
  "[Institute] Financial Institute User Count Load Error";

// Progress actiontypes
