...
const ReportRitBaseDateWise = React.lazy(() => import('./views/reports/upload_status/ritBaseDateWise'));
const ReportRitBankWise = React.lazy(() => import('./views/reports/upload_status/ritBankWise'));
const ReportNRBankBranch = React.lazy(() => import('./views/reports/upload_status/nonReportingBankBranch'));
...
const routes = [
  ...
  { path: '/report/rit-base-date-wise', name: 'Rit Report Base Date Wise', component: ReportRitBaseDateWise },
  { path: '/report/rit-bank-wise', name: 'Rit Report Bank Wise', component: ReportRitBankWise },
  { path: '/report/non-reporting-bank-branch', name: 'Non Reporting Bank Branch', component: ReportNRBankBranch },
